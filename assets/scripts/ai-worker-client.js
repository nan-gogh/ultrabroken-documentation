          ...
          try {
            w.share.addEventListener('click', () => {
              try {
                ...
                const disclaimer = '\n\n### Disclaimer\nThis response was generated by [The Librarian](https://nan-gogh.github.io/ultrabroken-documentation/wiki/about/#ai-search). It may contain inaccuracies — always verify against the source pages.';
